    ...
    return (
        <Link className="logo" href='/'>
            <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
                ...
                />
                <motion.path
                    d="M23.1253 26.557C25.6331 26.1501 27.3361 23.7872 26.9291 21.2795C26.5221 18.7717 24.1592 17.0687 21.6515 17.4757C19.1438 17.8827 17.4408 20.2456 17.8478 22.7533C18.2547 25.261 20.6176 26.964 23.1253 26.557Z"
                    fill="#000" 
            ...
            >
                <motion.span 
                    ...
                    transition={{duration: .3, delay: 1.45}}
                >
                    Cosmetic
                </motion.span>
                <motion.span 
                    className="logo__text--second"
                    initial={{
                        y: -30,
                        opacity: 0
                    }}
                    ...
                    transition={{duration: .3, delay: 1.8, type: "spring"}}
                >
                    GO
                </motion.span>
            </h3>
